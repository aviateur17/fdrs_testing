...
#define READING_ID    90   //Unique ID for this sensor
#define GTWY_MAC      0x23 //Address of the nearest gateway
...
#include <fdrs_node.h>
#define PING_TIME_DELAY 1000
#define REQ_TIME_DELAY 1000
#define LOAD_TIME_DELAY 10000
#define CYCLES 15
